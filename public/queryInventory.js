...
function BuildItemTable(queryResult)
{
    ...
    queryResult.forEach(item => {
        ...
        delButton.addEventListener("click",inventoryDel)
        var rowData = [currentIcon,item.name,item.ItemLevel,item.RequiredLevel,item.subclass,delButton];
...
{
    var e = document.getElementById("account-select");
